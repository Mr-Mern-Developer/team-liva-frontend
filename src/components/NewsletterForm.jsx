  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2" noValidate>
      ...
      <input
        ...
        className="min-w-0 flex-1 rounded-xl border border-slate-700 bg-slate-800/60 px-3 py-2.5 text-xs font-bold text-white placeholder:text-slate-500 focus:border-teal-500 focus:outline-none focus:ring-2 focus:ring-teal-500/20"
      />
      <button
        type="submit"
        disabled={submitting}
